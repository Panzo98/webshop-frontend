...
export default function Home() {
  ...
  return (
    <div className="min-h-[calc(100vh-6rem)] items-center justify-center flex">
      <form
        className="flex flex-col items-center shadow-xl border-[#00000010] border px-9 py-12 rounded-xl md:w-[400px] w-11/12"
        onSubmit={Login}
      >
        <h3 className="outline-none border-none leading-4 text-2xl font-bold">
          Login Here
        </h3>
        <label className="color-[#080710] mt-8 self-start">Username</label>
        <input
          value={username}
          className="h-12 w-full rounded-lg px-2 mt-2 text-sm font-light outline-1 outline-black border  border-[#00000036]"
          onChange={(e) => setUsername(e.target.value)}
          type="text"
          placeholder="Email or Username"
          onKeyDown={handleKeyPress}
        ></input>
        <label className="color-[#080710] mt-8 self-start">Password</label>
